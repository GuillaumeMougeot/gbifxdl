...
def resize_image(img, max_width, max_height):
    """ Resize the image to fit within max_width and max_height while keeping aspect ratio. """
    h, w = img.shape[:2]
...
def main():
    ...
    print(f"Loaded {len(images)} images to sort.")
    print(f"Press keys [1-{args.num_classes}] to sort images, 'c' to cancel the last sorting, 'f' for fullscreen, or 'q' to quit.")
